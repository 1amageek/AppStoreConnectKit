...
public struct SubscriptionIntroductoryOffer: Codable {
    ...
    public struct Attributes: Codable {
        ...
        public init(startDate: NaiveDate? = nil, endDate: NaiveDate? = nil, duration: SubscriptionOfferDuration? = nil, offerMode: SubscriptionOfferMode? = nil, numberOfPeriods: Int? = nil) {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.endDate = try values.decodeIfPresent(NaiveDate.self, forKey: "endDate")
