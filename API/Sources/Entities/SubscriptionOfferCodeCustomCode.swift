...
public struct SubscriptionOfferCodeCustomCode: Codable {
    ...
    public struct Attributes: Codable {
        ...
        public init(customCode: String? = nil, numberOfCodes: Int? = nil, createdDate: Date? = nil, expirationDate: NaiveDate? = nil, isActive: Bool? = nil) {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.expirationDate = try values.decodeIfPresent(NaiveDate.self, forKey: "expirationDate")
