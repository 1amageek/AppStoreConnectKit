...
extension Paths.V2.InAppPurchases.WithID {
    ...
    public struct PromotedPurchase {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.PromotedPurchaseResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "inAppPurchases-promotedPurchase-get_to_one_related")
        }
