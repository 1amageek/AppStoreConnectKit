...
extension Paths.V1.Subscriptions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.SubscriptionResponse> {
        ...
        public func patch(_ body: API.SubscriptionUpdateRequest) -> Request<API.SubscriptionResponse> {
