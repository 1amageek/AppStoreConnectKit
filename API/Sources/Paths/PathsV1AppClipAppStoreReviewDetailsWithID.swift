...
extension Paths.V1.AppClipAppStoreReviewDetails {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppClipAppStoreReviewDetails: [FieldsAppClipAppStoreReviewDetails]? = nil, include: [Include]? = nil) -> Request<API.AppClipAppStoreReviewDetailResponse> {
        ...
        public func patch(_ body: API.AppClipAppStoreReviewDetailUpdateRequest) -> Request<API.AppClipAppStoreReviewDetailResponse> {
