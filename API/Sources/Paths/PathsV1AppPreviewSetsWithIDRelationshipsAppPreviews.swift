...
extension Paths.V1.AppPreviewSets.WithID.Relationships {
    ...
    public struct AppPreviews {
        ...
        public func get(limit: Int? = nil) -> Request<API.AppPreviewSetAppPreviewsLinkagesResponse> {
        ...
        public func patch(_ body: API.AppPreviewSetAppPreviewsLinkagesRequest) -> Request<Void> {
