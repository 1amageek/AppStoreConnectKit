...
extension Paths.V1.Builds.WithID.Relationships {
    ...
    public struct AppEncryptionDeclaration {
        ...
        public var get: Request<API.BuildAppEncryptionDeclarationLinkageResponse> {
            Request(path: path, method: "GET", id: "builds-appEncryptionDeclaration-get_to_one_relationship")
        }

        public func patch(_ body: API.BuildAppEncryptionDeclarationLinkageRequest) -> Request<Void> {
