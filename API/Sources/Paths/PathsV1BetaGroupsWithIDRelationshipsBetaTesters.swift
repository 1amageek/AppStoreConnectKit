...
extension Paths.V1.BetaGroups.WithID.Relationships {
    ...
    public struct BetaTesters {
        ...
        public func get(limit: Int? = nil) -> Request<API.BetaGroupBetaTestersLinkagesResponse> {
        ...
        public func post(_ body: API.BetaGroupBetaTestersLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "betaGroups-betaTesters-create_to_many_relationship")
        }

        public func delete(_ body: API.BetaGroupBetaTestersLinkagesRequest) -> Request<Void> {
