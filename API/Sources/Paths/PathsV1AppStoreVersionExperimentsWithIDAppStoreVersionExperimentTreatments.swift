...
extension Paths.V1.AppStoreVersionExperiments.WithID {
    ...
    public struct AppStoreVersionExperimentTreatments {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreVersionExperimentTreatmentsResponse> {
