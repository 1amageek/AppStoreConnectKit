...
extension Paths.V1.SubscriptionGracePeriods {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionGracePeriods: [FieldsSubscriptionGracePeriods]? = nil) -> Request<API.SubscriptionGracePeriodResponse> {
        ...
        public func patch(_ body: API.SubscriptionGracePeriodUpdateRequest) -> Request<API.SubscriptionGracePeriodResponse> {
