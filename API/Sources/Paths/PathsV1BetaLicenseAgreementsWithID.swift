...
extension Paths.V1.BetaLicenseAgreements {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaLicenseAgreementResponse> {
        ...
        public func patch(_ body: API.BetaLicenseAgreementUpdateRequest) -> Request<API.BetaLicenseAgreementResponse> {
