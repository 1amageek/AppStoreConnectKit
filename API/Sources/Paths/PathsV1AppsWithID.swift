...
extension Paths.V1.Apps {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppResponse> {
        ...
        public func patch(_ body: API.AppUpdateRequest) -> Request<API.AppResponse> {
