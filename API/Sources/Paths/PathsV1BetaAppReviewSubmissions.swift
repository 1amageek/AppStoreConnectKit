...
extension Paths.V1 {
    ...
    public struct BetaAppReviewSubmissions {
        ...
        public func get(parameters: GetParameters) -> Request<API.BetaAppReviewSubmissionsResponse> {
        ...
        public func post(_ body: API.BetaAppReviewSubmissionCreateRequest) -> Request<API.BetaAppReviewSubmissionResponse> {
