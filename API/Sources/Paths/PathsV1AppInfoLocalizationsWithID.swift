...
extension Paths.V1.AppInfoLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppInfoLocalizations: [FieldsAppInfoLocalizations]? = nil, include: [Include]? = nil) -> Request<API.AppInfoLocalizationResponse> {
        ...
        public func patch(_ body: API.AppInfoLocalizationUpdateRequest) -> Request<API.AppInfoLocalizationResponse> {
