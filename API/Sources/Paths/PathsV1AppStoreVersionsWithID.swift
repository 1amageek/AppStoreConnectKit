...
extension Paths.V1.AppStoreVersions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreVersionResponse> {
        ...
        public func patch(_ body: API.AppStoreVersionUpdateRequest) -> Request<API.AppStoreVersionResponse> {
