...
extension Paths.V1.SubscriptionGroupLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionGroupLocalizations: [FieldsSubscriptionGroupLocalizations]? = nil, include: [Include]? = nil) -> Request<API.SubscriptionGroupLocalizationResponse> {
        ...
        public func patch(_ body: API.SubscriptionGroupLocalizationUpdateRequest) -> Request<API.SubscriptionGroupLocalizationResponse> {
