...
extension Paths.V1.BundleIDs {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BundleIDResponse> {
        ...
        public func patch(_ body: API.BundleIDUpdateRequest) -> Request<API.BundleIDResponse> {
