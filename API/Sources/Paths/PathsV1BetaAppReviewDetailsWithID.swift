...
extension Paths.V1.BetaAppReviewDetails {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaAppReviewDetailResponse> {
        ...
        public func patch(_ body: API.BetaAppReviewDetailUpdateRequest) -> Request<API.BetaAppReviewDetailResponse> {
