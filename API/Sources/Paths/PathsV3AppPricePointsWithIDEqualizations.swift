...
extension Paths.V3.AppPricePoints.WithID {
    ...
    public struct Equalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppPricePointsV3Response> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "appPricePoints-equalizations-get_to_many_related")
        }
