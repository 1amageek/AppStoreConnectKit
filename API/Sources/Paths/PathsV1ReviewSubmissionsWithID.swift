...
extension Paths.V1.ReviewSubmissions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.ReviewSubmissionResponse> {
        ...
        public func patch(_ body: API.ReviewSubmissionUpdateRequest) -> Request<API.ReviewSubmissionResponse> {
