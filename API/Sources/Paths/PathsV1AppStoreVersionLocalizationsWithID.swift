...
extension Paths.V1.AppStoreVersionLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreVersionLocalizationResponse> {
        ...
        public func patch(_ body: API.AppStoreVersionLocalizationUpdateRequest) -> Request<API.AppStoreVersionLocalizationResponse> {
