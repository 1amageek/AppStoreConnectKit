...
extension Paths.V1.AppStoreVersions.WithID {
    ...
    public struct AppStoreVersionLocalizations {
        ...
        public func get(fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations]? = nil, limit: Int? = nil) -> Request<API.AppStoreVersionLocalizationsResponse> {
