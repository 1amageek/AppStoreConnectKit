...
extension Paths.V1.AppClipDefaultExperiences.WithID {
    ...
    public struct AppClipDefaultExperienceLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppClipDefaultExperienceLocalizationsResponse> {
