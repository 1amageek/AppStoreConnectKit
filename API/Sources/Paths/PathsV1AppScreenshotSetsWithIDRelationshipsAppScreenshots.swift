...
extension Paths.V1.AppScreenshotSets.WithID.Relationships {
    ...
    public struct AppScreenshots {
        ...
        public func get(limit: Int? = nil) -> Request<API.AppScreenshotSetAppScreenshotsLinkagesResponse> {
        ...
        public func patch(_ body: API.AppScreenshotSetAppScreenshotsLinkagesRequest) -> Request<Void> {
