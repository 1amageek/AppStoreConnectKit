...
extension Paths.V1.AppStoreReviewDetails {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreReviewDetailResponse> {
        ...
        public func patch(_ body: API.AppStoreReviewDetailUpdateRequest) -> Request<API.AppStoreReviewDetailResponse> {
