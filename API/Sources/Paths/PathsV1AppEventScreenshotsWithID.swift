...
extension Paths.V1.AppEventScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppEventScreenshots: [FieldsAppEventScreenshots]? = nil, include: [Include]? = nil) -> Request<API.AppEventScreenshotResponse> {
        ...
        public func patch(_ body: API.AppEventScreenshotUpdateRequest) -> Request<API.AppEventScreenshotResponse> {
