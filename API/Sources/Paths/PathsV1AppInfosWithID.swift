...
extension Paths.V1.AppInfos {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppInfoResponse> {
        ...
        public func patch(_ body: API.AppInfoUpdateRequest) -> Request<API.AppInfoResponse> {
