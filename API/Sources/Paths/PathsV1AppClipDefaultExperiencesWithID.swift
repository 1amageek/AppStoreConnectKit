...
extension Paths.V1.AppClipDefaultExperiences {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppClipDefaultExperienceResponse> {
        ...
        public func patch(_ body: API.AppClipDefaultExperienceUpdateRequest) -> Request<API.AppClipDefaultExperienceResponse> {
