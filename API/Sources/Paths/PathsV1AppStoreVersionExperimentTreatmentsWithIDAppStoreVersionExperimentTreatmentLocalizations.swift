...
extension Paths.V1.AppStoreVersionExperimentTreatments.WithID {
    ...
    public struct AppStoreVersionExperimentTreatmentLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreVersionExperimentTreatmentLocalizationsResponse> {
