...
extension Paths.V1.BetaTesters.WithID.Relationships {
    ...
    public struct Builds {
        ...
        public func get(limit: Int? = nil) -> Request<API.BetaTesterBuildsLinkagesResponse> {
        ...
        public func post(_ body: API.BetaTesterBuildsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "betaTesters-builds-create_to_many_relationship")
        }

        public func delete(_ body: API.BetaTesterBuildsLinkagesRequest) -> Request<Void> {
