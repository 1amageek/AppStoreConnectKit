...
extension Paths.V2.InAppPurchases.WithID {
    ...
    public struct InAppPurchaseLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.InAppPurchaseLocalizationsResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "inAppPurchases-inAppPurchaseLocalizations-get_to_many_related")
        }
