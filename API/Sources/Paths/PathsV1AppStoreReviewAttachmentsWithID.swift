...
extension Paths.V1.AppStoreReviewAttachments {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppStoreReviewAttachments: [FieldsAppStoreReviewAttachments]? = nil, include: [Include]? = nil) -> Request<API.AppStoreReviewAttachmentResponse> {
        ...
        public func patch(_ body: API.AppStoreReviewAttachmentUpdateRequest) -> Request<API.AppStoreReviewAttachmentResponse> {
