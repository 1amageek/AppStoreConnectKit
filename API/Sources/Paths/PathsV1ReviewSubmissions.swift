...
extension Paths.V1 {
    ...
    public struct ReviewSubmissions {
        ...
        public func get(parameters: GetParameters) -> Request<API.ReviewSubmissionsResponse> {
        ...
        public func post(_ body: API.ReviewSubmissionCreateRequest) -> Request<API.ReviewSubmissionResponse> {
