...
extension Paths.V1.AppStoreVersionExperiments {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreVersionExperimentResponse> {
        ...
        public func patch(_ body: API.AppStoreVersionExperimentUpdateRequest) -> Request<API.AppStoreVersionExperimentResponse> {
