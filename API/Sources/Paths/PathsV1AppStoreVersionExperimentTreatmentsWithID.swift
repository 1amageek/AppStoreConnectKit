...
extension Paths.V1.AppStoreVersionExperimentTreatments {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppStoreVersionExperimentTreatmentResponse> {
        ...
        public func patch(_ body: API.AppStoreVersionExperimentTreatmentUpdateRequest) -> Request<API.AppStoreVersionExperimentTreatmentResponse> {
