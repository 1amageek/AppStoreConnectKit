...
extension Paths.V1 {
    ...
    public struct Certificates {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.CertificatesResponse> {
        ...
        public func post(_ body: API.CertificateCreateRequest) -> Request<API.CertificateResponse> {
