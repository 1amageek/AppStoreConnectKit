...
extension Paths.V1.BetaGroups.WithID.Relationships {
    ...
    public struct Builds {
        ...
        public func get(limit: Int? = nil) -> Request<API.BetaGroupBuildsLinkagesResponse> {
        ...
        public func post(_ body: API.BetaGroupBuildsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "betaGroups-builds-create_to_many_relationship")
        }

        public func delete(_ body: API.BetaGroupBuildsLinkagesRequest) -> Request<Void> {
