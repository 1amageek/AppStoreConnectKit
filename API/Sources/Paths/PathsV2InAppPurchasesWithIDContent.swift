...
extension Paths.V2.InAppPurchases.WithID {
    ...
    public struct Content {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.InAppPurchaseContentResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "inAppPurchases-content-get_to_one_related")
        }
