...
extension Paths.V1.SubscriptionOfferCodes {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.SubscriptionOfferCodeResponse> {
        ...
        public func patch(_ body: API.SubscriptionOfferCodeUpdateRequest) -> Request<API.SubscriptionOfferCodeResponse> {
