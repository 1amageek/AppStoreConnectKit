...
extension Paths.V1.Devices {
    ...
    public struct WithID {
        ...
        public func get(fieldsDevices: [FieldsDevices]? = nil) -> Request<API.DeviceResponse> {
        ...
        public func patch(_ body: API.DeviceUpdateRequest) -> Request<API.DeviceResponse> {
