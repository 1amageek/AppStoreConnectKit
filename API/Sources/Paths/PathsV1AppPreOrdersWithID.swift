...
extension Paths.V1.AppPreOrders {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppPreOrders: [FieldsAppPreOrders]? = nil, include: [Include]? = nil) -> Request<API.AppPreOrderResponse> {
        ...
        public func patch(_ body: API.AppPreOrderUpdateRequest) -> Request<API.AppPreOrderResponse> {
