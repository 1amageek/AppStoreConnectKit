...
extension Paths.V1 {
    ...
    public struct BetaTesters {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaTestersResponse> {
        ...
        public func post(_ body: API.BetaTesterCreateRequest) -> Request<API.BetaTesterResponse> {
