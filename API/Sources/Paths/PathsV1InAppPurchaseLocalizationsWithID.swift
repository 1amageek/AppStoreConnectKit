...
extension Paths.V1.InAppPurchaseLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsInAppPurchaseLocalizations: [FieldsInAppPurchaseLocalizations]? = nil, include: [Include]? = nil) -> Request<API.InAppPurchaseLocalizationResponse> {
        ...
        public func patch(_ body: API.InAppPurchaseLocalizationUpdateRequest) -> Request<API.InAppPurchaseLocalizationResponse> {
