...
extension Paths.V1 {
    ...
    public struct BetaGroups {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaGroupsResponse> {
        ...
        public func post(_ body: API.BetaGroupCreateRequest) -> Request<API.BetaGroupResponse> {
