...
extension Paths.V1.AppClipDefaultExperienceLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppClipDefaultExperienceLocalizationResponse> {
        ...
        public func patch(_ body: API.AppClipDefaultExperienceLocalizationUpdateRequest) -> Request<API.AppClipDefaultExperienceLocalizationResponse> {
