...
extension Paths.V1.AppCustomProductPageVersions.WithID {
    ...
    public struct AppCustomProductPageLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppCustomProductPageLocalizationsResponse> {
