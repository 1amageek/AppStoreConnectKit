...
extension Paths.V1.SubscriptionGroups {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.SubscriptionGroupResponse> {
        ...
        public func patch(_ body: API.SubscriptionGroupUpdateRequest) -> Request<API.SubscriptionGroupResponse> {
