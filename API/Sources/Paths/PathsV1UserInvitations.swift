...
extension Paths.V1 {
    ...
    public struct UserInvitations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.UserInvitationsResponse> {
        ...
        public func post(_ body: API.UserInvitationCreateRequest) -> Request<API.UserInvitationResponse> {
