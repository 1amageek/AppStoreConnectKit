...
extension Paths.V1.AppStoreVersionExperimentTreatmentLocalizations.WithID {
    ...
    public struct AppScreenshotSets {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppScreenshotSetsResponse> {
