...
extension Paths.V2.InAppPurchases.WithID {
    ...
    public struct PricePoints {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.InAppPurchasePricePointsResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "inAppPurchases-pricePoints-get_to_many_related")
        }
