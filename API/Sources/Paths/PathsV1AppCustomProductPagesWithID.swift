...
extension Paths.V1.AppCustomProductPages {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppCustomProductPageResponse> {
        ...
        public func patch(_ body: API.AppCustomProductPageUpdateRequest) -> Request<API.AppCustomProductPageResponse> {
