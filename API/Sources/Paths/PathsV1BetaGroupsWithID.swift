...
extension Paths.V1.BetaGroups {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaGroupResponse> {
        ...
        public func patch(_ body: API.BetaGroupUpdateRequest) -> Request<API.BetaGroupResponse> {
