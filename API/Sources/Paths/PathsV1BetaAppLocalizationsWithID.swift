...
extension Paths.V1.BetaAppLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaAppLocalizationResponse> {
        ...
        public func patch(_ body: API.BetaAppLocalizationUpdateRequest) -> Request<API.BetaAppLocalizationResponse> {
