...
extension Paths.V1.AppEvents {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppEventResponse> {
        ...
        public func patch(_ body: API.AppEventUpdateRequest) -> Request<API.AppEventResponse> {
