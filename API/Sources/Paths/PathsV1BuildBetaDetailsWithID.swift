...
extension Paths.V1.BuildBetaDetails {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BuildBetaDetailResponse> {
        ...
        public func patch(_ body: API.BuildBetaDetailUpdateRequest) -> Request<API.BuildBetaDetailResponse> {
