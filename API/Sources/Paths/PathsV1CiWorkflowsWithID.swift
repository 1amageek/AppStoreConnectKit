...
extension Paths.V1.CiWorkflows {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.CiWorkflowResponse> {
        ...
        public func patch(_ body: API.CiWorkflowUpdateRequest) -> Request<API.CiWorkflowResponse> {
