...
extension Paths.V1.Users {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.UserResponse> {
        ...
        public func patch(_ body: API.UserUpdateRequest) -> Request<API.UserResponse> {
