...
extension Paths.V1 {
    ...
    public struct BundleIDs {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BundleIDsResponse> {
        ...
        public func post(_ body: API.BundleIDCreateRequest) -> Request<API.BundleIDResponse> {
