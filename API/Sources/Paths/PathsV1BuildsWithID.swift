...
extension Paths.V1.Builds {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BuildResponse> {
        ...
        public func patch(_ body: API.BuildUpdateRequest) -> Request<API.BuildResponse> {
