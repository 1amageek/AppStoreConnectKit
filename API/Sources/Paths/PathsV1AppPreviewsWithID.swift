...
extension Paths.V1.AppPreviews {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppPreviews: [FieldsAppPreviews]? = nil, include: [Include]? = nil) -> Request<API.AppPreviewResponse> {
        ...
        public func patch(_ body: API.AppPreviewUpdateRequest) -> Request<API.AppPreviewResponse> {
