...
extension Paths.V1.PromotedPurchaseImages {
    ...
    public struct WithID {
        ...
        public func get(fieldsPromotedPurchaseImages: [FieldsPromotedPurchaseImages]? = nil, include: [Include]? = nil) -> Request<API.PromotedPurchaseImageResponse> {
        ...
        public func patch(_ body: API.PromotedPurchaseImageUpdateRequest) -> Request<API.PromotedPurchaseImageResponse> {
