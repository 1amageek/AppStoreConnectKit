...
extension Paths.V1.AppEventLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.AppEventLocalizationResponse> {
        ...
        public func patch(_ body: API.AppEventLocalizationUpdateRequest) -> Request<API.AppEventLocalizationResponse> {
