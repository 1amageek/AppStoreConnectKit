...
extension Paths.V1 {
    ...
    public struct BetaBuildLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.BetaBuildLocalizationsResponse> {
        ...
        public func post(_ body: API.BetaBuildLocalizationCreateRequest) -> Request<API.BetaBuildLocalizationResponse> {
