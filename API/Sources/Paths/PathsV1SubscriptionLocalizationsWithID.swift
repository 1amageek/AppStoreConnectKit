...
extension Paths.V1.SubscriptionLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionLocalizations: [FieldsSubscriptionLocalizations]? = nil, include: [Include]? = nil) -> Request<API.SubscriptionLocalizationResponse> {
        ...
        public func patch(_ body: API.SubscriptionLocalizationUpdateRequest) -> Request<API.SubscriptionLocalizationResponse> {
