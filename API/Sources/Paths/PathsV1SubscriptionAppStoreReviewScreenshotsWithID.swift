...
extension Paths.V1.SubscriptionAppStoreReviewScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionAppStoreReviewScreenshots: [FieldsSubscriptionAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<API.SubscriptionAppStoreReviewScreenshotResponse> {
        ...
        public func patch(_ body: API.SubscriptionAppStoreReviewScreenshotUpdateRequest) -> Request<API.SubscriptionAppStoreReviewScreenshotResponse> {
