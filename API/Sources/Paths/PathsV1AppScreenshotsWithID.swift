...
extension Paths.V1.AppScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppScreenshots: [FieldsAppScreenshots]? = nil, include: [Include]? = nil) -> Request<API.AppScreenshotResponse> {
        ...
        public func patch(_ body: API.AppScreenshotUpdateRequest) -> Request<API.AppScreenshotResponse> {
