...
extension Paths.V2.InAppPurchases.WithID {
    ...
    public struct IapPriceSchedule {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.InAppPurchasePriceScheduleResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "inAppPurchases-iapPriceSchedule-get_to_one_related")
        }
