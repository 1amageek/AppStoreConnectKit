...
extension Paths.V2.InAppPurchases.WithID {
    ...
    public struct AppStoreReviewScreenshot {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<API.InAppPurchaseAppStoreReviewScreenshotResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "inAppPurchases-appStoreReviewScreenshot-get_to_one_related")
        }
