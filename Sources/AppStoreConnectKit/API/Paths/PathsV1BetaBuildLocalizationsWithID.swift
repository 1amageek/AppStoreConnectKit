...
extension Paths.V1.BetaBuildLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BetaBuildLocalizationResponse> {
        ...
        public func patch(_ body: BetaBuildLocalizationUpdateRequest) -> Request<BetaBuildLocalizationResponse> {
