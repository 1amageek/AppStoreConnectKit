...
extension Paths.V1.AppStoreReviewAttachments {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppStoreReviewAttachments: [FieldsAppStoreReviewAttachments]? = nil, include: [Include]? = nil) -> Request<AppStoreReviewAttachmentResponse> {
        ...
        public func patch(_ body: AppStoreReviewAttachmentUpdateRequest) -> Request<AppStoreReviewAttachmentResponse> {
