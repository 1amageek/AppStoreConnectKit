...
extension Paths.V1.Users.WithID.Relationships {
    ...
    public struct VisibleApps {
        ...
        public func get(limit: Int? = nil) -> Request<UserVisibleAppsLinkagesResponse> {
        ...
        public func post(_ body: UserVisibleAppsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "users-visibleApps-create_to_many_relationship")
        }

        public func patch(_ body: UserVisibleAppsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "PATCH", body: body, id: "users-visibleApps-replace_to_many_relationship")
        }

        public func delete(_ body: UserVisibleAppsLinkagesRequest) -> Request<Void> {
