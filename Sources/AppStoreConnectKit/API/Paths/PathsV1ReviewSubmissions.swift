...
extension Paths.V1 {
    ...
    public struct ReviewSubmissions {
        ...
        public func get(parameters: GetParameters) -> Request<ReviewSubmissionsResponse> {
        ...
        public func post(_ body: ReviewSubmissionCreateRequest) -> Request<ReviewSubmissionResponse> {
