...
extension Paths.V2.InAppPurchases {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<InAppPurchaseV2Response> {
        ...
        public func patch(_ body: InAppPurchaseV2UpdateRequest) -> Request<InAppPurchaseV2Response> {
