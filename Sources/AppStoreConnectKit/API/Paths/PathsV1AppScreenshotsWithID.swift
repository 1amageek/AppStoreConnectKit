...
extension Paths.V1.AppScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppScreenshots: [FieldsAppScreenshots]? = nil, include: [Include]? = nil) -> Request<AppScreenshotResponse> {
        ...
        public func patch(_ body: AppScreenshotUpdateRequest) -> Request<AppScreenshotResponse> {
