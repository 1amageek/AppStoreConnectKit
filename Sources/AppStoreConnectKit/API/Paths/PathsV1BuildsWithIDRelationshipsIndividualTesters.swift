...
extension Paths.V1.Builds.WithID.Relationships {
    ...
    public struct IndividualTesters {
        ...
        public func get(limit: Int? = nil) -> Request<BuildIndividualTestersLinkagesResponse> {
        ...
        public func post(_ body: BuildIndividualTestersLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "builds-individualTesters-create_to_many_relationship")
        }

        public func delete(_ body: BuildIndividualTestersLinkagesRequest) -> Request<Void> {
