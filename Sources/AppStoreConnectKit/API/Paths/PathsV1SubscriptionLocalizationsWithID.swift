...
extension Paths.V1.SubscriptionLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionLocalizations: [FieldsSubscriptionLocalizations]? = nil, include: [Include]? = nil) -> Request<SubscriptionLocalizationResponse> {
        ...
        public func patch(_ body: SubscriptionLocalizationUpdateRequest) -> Request<SubscriptionLocalizationResponse> {
