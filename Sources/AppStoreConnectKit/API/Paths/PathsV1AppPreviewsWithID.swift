...
extension Paths.V1.AppPreviews {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppPreviews: [FieldsAppPreviews]? = nil, include: [Include]? = nil) -> Request<AppPreviewResponse> {
        ...
        public func patch(_ body: AppPreviewUpdateRequest) -> Request<AppPreviewResponse> {
