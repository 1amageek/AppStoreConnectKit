...
extension Paths.V1.RoutingAppCoverages {
    ...
    public struct WithID {
        ...
        public func get(fieldsRoutingAppCoverages: [FieldsRoutingAppCoverages]? = nil, include: [Include]? = nil) -> Request<RoutingAppCoverageResponse> {
        ...
        public func patch(_ body: RoutingAppCoverageUpdateRequest) -> Request<RoutingAppCoverageResponse> {
