...
extension Paths.V1.AppCustomProductPages {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppCustomProductPageResponse> {
        ...
        public func patch(_ body: AppCustomProductPageUpdateRequest) -> Request<AppCustomProductPageResponse> {
