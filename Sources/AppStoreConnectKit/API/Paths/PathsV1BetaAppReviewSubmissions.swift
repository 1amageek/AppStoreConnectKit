...
extension Paths.V1 {
    ...
    public struct BetaAppReviewSubmissions {
        ...
        public func get(parameters: GetParameters) -> Request<BetaAppReviewSubmissionsResponse> {
        ...
        public func post(_ body: BetaAppReviewSubmissionCreateRequest) -> Request<BetaAppReviewSubmissionResponse> {
