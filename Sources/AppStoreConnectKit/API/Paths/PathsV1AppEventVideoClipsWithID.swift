...
extension Paths.V1.AppEventVideoClips {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppEventVideoClips: [FieldsAppEventVideoClips]? = nil, include: [Include]? = nil) -> Request<AppEventVideoClipResponse> {
        ...
        public func patch(_ body: AppEventVideoClipUpdateRequest) -> Request<AppEventVideoClipResponse> {
