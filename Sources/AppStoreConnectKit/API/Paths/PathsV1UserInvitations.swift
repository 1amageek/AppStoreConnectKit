...
extension Paths.V1 {
    ...
    public struct UserInvitations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<UserInvitationsResponse> {
        ...
        public func post(_ body: UserInvitationCreateRequest) -> Request<UserInvitationResponse> {
