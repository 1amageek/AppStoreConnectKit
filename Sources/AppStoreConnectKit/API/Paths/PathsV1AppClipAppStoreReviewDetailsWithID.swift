...
extension Paths.V1.AppClipAppStoreReviewDetails {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppClipAppStoreReviewDetails: [FieldsAppClipAppStoreReviewDetails]? = nil, include: [Include]? = nil) -> Request<AppClipAppStoreReviewDetailResponse> {
        ...
        public func patch(_ body: AppClipAppStoreReviewDetailUpdateRequest) -> Request<AppClipAppStoreReviewDetailResponse> {
