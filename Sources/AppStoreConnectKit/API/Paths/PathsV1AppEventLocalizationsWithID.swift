...
extension Paths.V1.AppEventLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppEventLocalizationResponse> {
        ...
        public func patch(_ body: AppEventLocalizationUpdateRequest) -> Request<AppEventLocalizationResponse> {
