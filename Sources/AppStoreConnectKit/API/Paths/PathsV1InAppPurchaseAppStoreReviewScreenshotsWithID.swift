...
extension Paths.V1.InAppPurchaseAppStoreReviewScreenshots {
    ...
    public struct WithID {
        ...
        public func get(fieldsInAppPurchaseAppStoreReviewScreenshots: [FieldsInAppPurchaseAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<InAppPurchaseAppStoreReviewScreenshotResponse> {
        ...
        public func patch(_ body: InAppPurchaseAppStoreReviewScreenshotUpdateRequest) -> Request<InAppPurchaseAppStoreReviewScreenshotResponse> {
