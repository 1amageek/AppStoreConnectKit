...
extension Paths.V1.AppInfoLocalizations {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppInfoLocalizations: [FieldsAppInfoLocalizations]? = nil, include: [Include]? = nil) -> Request<AppInfoLocalizationResponse> {
        ...
        public func patch(_ body: AppInfoLocalizationUpdateRequest) -> Request<AppInfoLocalizationResponse> {
