...
extension Paths.V1.Subscriptions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<SubscriptionResponse> {
        ...
        public func patch(_ body: SubscriptionUpdateRequest) -> Request<SubscriptionResponse> {
