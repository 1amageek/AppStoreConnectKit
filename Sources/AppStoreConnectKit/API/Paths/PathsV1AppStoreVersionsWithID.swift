...
extension Paths.V1.AppStoreVersions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreVersionResponse> {
        ...
        public func patch(_ body: AppStoreVersionUpdateRequest) -> Request<AppStoreVersionResponse> {
