...
extension Paths.V1.BuildBetaDetails {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BuildBetaDetailResponse> {
        ...
        public func patch(_ body: BuildBetaDetailUpdateRequest) -> Request<BuildBetaDetailResponse> {
