...
extension Paths.V1.BetaAppClipInvocations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BetaAppClipInvocationResponse> {
        ...
        public func patch(_ body: BetaAppClipInvocationUpdateRequest) -> Request<BetaAppClipInvocationResponse> {
