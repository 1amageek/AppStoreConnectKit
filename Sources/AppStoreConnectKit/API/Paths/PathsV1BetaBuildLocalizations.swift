...
extension Paths.V1 {
    ...
    public struct BetaBuildLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BetaBuildLocalizationsResponse> {
        ...
        public func post(_ body: BetaBuildLocalizationCreateRequest) -> Request<BetaBuildLocalizationResponse> {
