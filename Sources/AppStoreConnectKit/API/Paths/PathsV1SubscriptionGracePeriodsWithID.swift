...
extension Paths.V1.SubscriptionGracePeriods {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionGracePeriods: [FieldsSubscriptionGracePeriods]? = nil) -> Request<SubscriptionGracePeriodResponse> {
        ...
        public func patch(_ body: SubscriptionGracePeriodUpdateRequest) -> Request<SubscriptionGracePeriodResponse> {
