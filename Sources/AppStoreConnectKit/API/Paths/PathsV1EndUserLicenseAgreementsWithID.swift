...
extension Paths.V1.EndUserLicenseAgreements {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<EndUserLicenseAgreementResponse> {
        ...
        public func patch(_ body: EndUserLicenseAgreementUpdateRequest) -> Request<EndUserLicenseAgreementResponse> {
