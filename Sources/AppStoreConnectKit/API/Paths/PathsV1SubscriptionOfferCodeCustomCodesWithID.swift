...
extension Paths.V1.SubscriptionOfferCodeCustomCodes {
    ...
    public struct WithID {
        ...
        public func get(fieldsSubscriptionOfferCodeCustomCodes: [FieldsSubscriptionOfferCodeCustomCodes]? = nil, include: [Include]? = nil) -> Request<SubscriptionOfferCodeCustomCodeResponse> {
        ...
        public func patch(_ body: SubscriptionOfferCodeCustomCodeUpdateRequest) -> Request<SubscriptionOfferCodeCustomCodeResponse> {
