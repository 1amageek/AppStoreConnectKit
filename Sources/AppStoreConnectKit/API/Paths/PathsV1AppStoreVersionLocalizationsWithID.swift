...
extension Paths.V1.AppStoreVersionLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreVersionLocalizationResponse> {
        ...
        public func patch(_ body: AppStoreVersionLocalizationUpdateRequest) -> Request<AppStoreVersionLocalizationResponse> {
