...
extension Paths.V1.AppStoreVersionExperimentTreatments {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreVersionExperimentTreatmentResponse> {
        ...
        public func patch(_ body: AppStoreVersionExperimentTreatmentUpdateRequest) -> Request<AppStoreVersionExperimentTreatmentResponse> {
