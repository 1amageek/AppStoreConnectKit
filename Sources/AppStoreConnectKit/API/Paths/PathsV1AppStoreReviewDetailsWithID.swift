...
extension Paths.V1.AppStoreReviewDetails {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppStoreReviewDetailResponse> {
        ...
        public func patch(_ body: AppStoreReviewDetailUpdateRequest) -> Request<AppStoreReviewDetailResponse> {
