...
extension Paths.V1.AppClipDefaultExperiences {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppClipDefaultExperienceResponse> {
        ...
        public func patch(_ body: AppClipDefaultExperienceUpdateRequest) -> Request<AppClipDefaultExperienceResponse> {
