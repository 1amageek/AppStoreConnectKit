...
extension Paths.V1.AppPreOrders {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppPreOrders: [FieldsAppPreOrders]? = nil, include: [Include]? = nil) -> Request<AppPreOrderResponse> {
        ...
        public func patch(_ body: AppPreOrderUpdateRequest) -> Request<AppPreOrderResponse> {
