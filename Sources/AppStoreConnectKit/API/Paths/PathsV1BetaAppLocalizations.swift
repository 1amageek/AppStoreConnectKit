...
extension Paths.V1 {
    ...
    public struct BetaAppLocalizations {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BetaAppLocalizationsResponse> {
        ...
        public func post(_ body: BetaAppLocalizationCreateRequest) -> Request<BetaAppLocalizationResponse> {
