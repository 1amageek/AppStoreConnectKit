...
extension Paths.V1.BetaAppLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BetaAppLocalizationResponse> {
        ...
        public func patch(_ body: BetaAppLocalizationUpdateRequest) -> Request<BetaAppLocalizationResponse> {
