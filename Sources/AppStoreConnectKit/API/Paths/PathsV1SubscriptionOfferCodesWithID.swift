...
extension Paths.V1.SubscriptionOfferCodes {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<SubscriptionOfferCodeResponse> {
        ...
        public func patch(_ body: SubscriptionOfferCodeUpdateRequest) -> Request<SubscriptionOfferCodeResponse> {
