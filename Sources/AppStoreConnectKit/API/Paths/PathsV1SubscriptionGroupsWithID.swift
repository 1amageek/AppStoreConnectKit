...
extension Paths.V1.SubscriptionGroups {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<SubscriptionGroupResponse> {
        ...
        public func patch(_ body: SubscriptionGroupUpdateRequest) -> Request<SubscriptionGroupResponse> {
