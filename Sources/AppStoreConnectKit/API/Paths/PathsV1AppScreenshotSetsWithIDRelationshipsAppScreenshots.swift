...
extension Paths.V1.AppScreenshotSets.WithID.Relationships {
    ...
    public struct AppScreenshots {
        ...
        public func get(limit: Int? = nil) -> Request<AppScreenshotSetAppScreenshotsLinkagesResponse> {
        ...
        public func patch(_ body: AppScreenshotSetAppScreenshotsLinkagesRequest) -> Request<Void> {
