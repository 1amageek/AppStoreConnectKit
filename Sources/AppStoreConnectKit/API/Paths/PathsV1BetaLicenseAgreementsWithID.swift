...
extension Paths.V1.BetaLicenseAgreements {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<BetaLicenseAgreementResponse> {
        ...
        public func patch(_ body: BetaLicenseAgreementUpdateRequest) -> Request<BetaLicenseAgreementResponse> {
