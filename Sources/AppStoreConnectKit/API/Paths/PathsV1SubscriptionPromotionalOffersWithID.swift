...
extension Paths.V1.SubscriptionPromotionalOffers {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<SubscriptionPromotionalOfferResponse> {
        ...
        public func patch(_ body: SubscriptionPromotionalOfferUpdateRequest) -> Request<SubscriptionPromotionalOfferResponse> {
