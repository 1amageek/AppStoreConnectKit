...
extension Paths.V1.AppCustomProductPageLocalizations {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppCustomProductPageLocalizationResponse> {
        ...
        public func patch(_ body: AppCustomProductPageLocalizationUpdateRequest) -> Request<AppCustomProductPageLocalizationResponse> {
