...
extension Paths.V1.ReviewSubmissions {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<ReviewSubmissionResponse> {
        ...
        public func patch(_ body: ReviewSubmissionUpdateRequest) -> Request<ReviewSubmissionResponse> {
