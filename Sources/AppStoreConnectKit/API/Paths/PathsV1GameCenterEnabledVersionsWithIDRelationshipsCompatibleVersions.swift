...
extension Paths.V1.GameCenterEnabledVersions.WithID.Relationships {
    ...
    public struct CompatibleVersions {
        ...
        public func get(limit: Int? = nil) -> Request<GameCenterEnabledVersionCompatibleVersionsLinkagesResponse> {
        ...
        public func post(_ body: GameCenterEnabledVersionCompatibleVersionsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "POST", body: body, id: "gameCenterEnabledVersions-compatibleVersions-create_to_many_relationship")
        }

        public func patch(_ body: GameCenterEnabledVersionCompatibleVersionsLinkagesRequest) -> Request<Void> {
            Request(path: path, method: "PATCH", body: body, id: "gameCenterEnabledVersions-compatibleVersions-replace_to_many_relationship")
        }

        public func delete(_ body: GameCenterEnabledVersionCompatibleVersionsLinkagesRequest) -> Request<Void> {
