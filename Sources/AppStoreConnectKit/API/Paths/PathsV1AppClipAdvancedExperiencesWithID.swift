...
extension Paths.V1.AppClipAdvancedExperiences {
    ...
    public struct WithID {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<AppClipAdvancedExperienceResponse> {
        ...
        public func patch(_ body: AppClipAdvancedExperienceUpdateRequest) -> Request<AppClipAdvancedExperienceResponse> {
