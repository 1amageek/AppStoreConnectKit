...
extension Paths.V1.AppEncryptionDeclarationDocuments {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppEncryptionDeclarationDocuments: [FieldsAppEncryptionDeclarationDocuments]? = nil) -> Request<AppEncryptionDeclarationDocumentResponse> {
        ...
        public func patch(_ body: AppEncryptionDeclarationDocumentUpdateRequest) -> Request<AppEncryptionDeclarationDocumentResponse> {
