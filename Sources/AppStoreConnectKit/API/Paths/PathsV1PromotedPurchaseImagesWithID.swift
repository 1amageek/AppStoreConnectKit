...
extension Paths.V1.PromotedPurchaseImages {
    ...
    public struct WithID {
        ...
        public func get(fieldsPromotedPurchaseImages: [FieldsPromotedPurchaseImages]? = nil, include: [Include]? = nil) -> Request<PromotedPurchaseImageResponse> {
        ...
        public func patch(_ body: PromotedPurchaseImageUpdateRequest) -> Request<PromotedPurchaseImageResponse> {
