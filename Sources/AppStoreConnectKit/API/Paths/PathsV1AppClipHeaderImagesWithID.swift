...
extension Paths.V1.AppClipHeaderImages {
    ...
    public struct WithID {
        ...
        public func get(fieldsAppClipHeaderImages: [FieldsAppClipHeaderImages]? = nil, include: [Include]? = nil) -> Request<AppClipHeaderImageResponse> {
        ...
        public func patch(_ body: AppClipHeaderImageUpdateRequest) -> Request<AppClipHeaderImageResponse> {
